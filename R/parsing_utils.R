...
#' Create Save-Specification for Classifiers
#' 
#' Creates specification to save classification models.
#' 
#' @inheritParams classifier_parse_example_spec
#' 
#' @export
#' @family parsing utilities
tf_save_classifier_spec <- function(
  feature_columns,
  label_key = "label",
  ...
  structure(
    class = "tf_save_estimator_spec",
    as.list(environment(), all = TRUE)
  )
}

#' Creates Save-Specification for Regressors
#' 
#' Creates specification to save regression models.
#' 
#' @inheritParams regressor_parse_example_spec
#' 
#' @export
#' @family parsing utilities
tf_save_regressor_spec <- function(
  feature_columns,
  label_key = "label",
  label_dtype = tf$float32,
  label_default = NULL,
