tf_estimator <- function(estimator, classes, history = NULL, params = NULL) {
  structure(
    list(
      estimator = estimator,
      history = history,
...
tf_regressor <- function(estimator, class, params = NULL) {
  tf_estimator(estimator, c("regressor", class), params = params)
}

tf_classifier <- function(estimator, class, params = NULL) {
  tf_estimator(estimator, c("classifier", class), params = params)
}
