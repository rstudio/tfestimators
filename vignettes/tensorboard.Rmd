...
![](tensorboard-loss.png){width=750 height=545 .screenshot}



Here's another TensorBoard display for this model's TensorFlow graph that demonstrates the architecture of the model:

![](tensorboard-graph.png){width=750 height=545 .screenshot}


You can also click to see each subgraph's details


![](tensorboard-graph-details.png){width=750 height=545 .screenshot}
