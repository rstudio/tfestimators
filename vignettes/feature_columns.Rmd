...
If the code you are using to compose columns is more complicated, or if you need save references to columns for use in column embeddings you can also establish a scope for given set of column names using the `with_columns()` function:
